...
public class World2 extends World{
    ...
    public void addElements(MarioSurfaceView view){
        ...
        addLine(tileWidth * 43, screenHeight - tileWidth * 1, 30, imageLoader.get(3));
        addLine(tileWidth*43, screenHeight-tileWidth*2, 30, imageLoader.get(3));

        enemies.add(new Goomba(tileWidth * 50, screenHeight - tileWidth * 3, view, scene));
        enemies.add(new Goomba(tileWidth*52, screenHeight-tileWidth*3, view, scene));
        enemies.add(new Goomba(tileWidth*54, screenHeight-tileWidth*3, view, scene));
        enemies.add(new Goomba(tileWidth*56, screenHeight-tileWidth*3, view, scene));
        enemies.add(new Goomba(tileWidth*58, screenHeight-tileWidth*3, view, scene));

        scene.add(new Flag(tileWidth*60, screenHeight - tileWidth*1, view));
